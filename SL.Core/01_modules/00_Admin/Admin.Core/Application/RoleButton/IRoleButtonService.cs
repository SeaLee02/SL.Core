...
namespace SL.Mkh.Admin.Core.Application.RoleButton
{
    ...
    public interface IRoleButtonService
    {
        ...
        /// <returns></returns>
        Task<IResultModel> GetList(RoleButtonQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(RoleButtonAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(RoleButtonAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>     
        Task<byte[]> ExportExcel(RoleButtonQueryDto dto);
