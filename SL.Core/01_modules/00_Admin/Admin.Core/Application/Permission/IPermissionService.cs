...
namespace SL.Mkh.Admin.Core.Application.Permission
{
    ...
    public interface IPermissionService
    {
        ...
        /// <returns></returns>
        Task<IResultModel> GetList(PermissionQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(PermissionAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(PermissionAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>     
        Task<byte[]> ExportExcel(PermissionQueryDto dto);
