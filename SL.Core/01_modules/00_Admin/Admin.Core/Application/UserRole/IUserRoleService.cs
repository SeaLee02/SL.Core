...
namespace SL.Mkh.Admin.Core.Application.UserRole
{
    ...
    public interface IUserRoleService
    {
        ...
        /// <returns></returns>
        Task<IResultModel> GetList(UserRoleQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(UserRoleAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(UserRoleAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>     
        Task<byte[]> ExportExcel(UserRoleQueryDto dto);
