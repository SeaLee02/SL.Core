...
namespace SL.Mkh.Admin.Core.Application.Button
{
    ...
    public interface IButtonService
    {
        ...
        /// <returns></returns>
        Task<IResultModel> GetList(ButtonQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(ButtonAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(ButtonAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>     
        Task<byte[]> ExportExcel(ButtonQueryDto dto);
