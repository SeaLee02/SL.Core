...
namespace SL.Mkh.Admin.Web.Controllers
{
    ...
    public class TenantController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<IResultModel> GetList([FromQuery] TenantQueryDto dto)
        {
            return await _tenantService.GetList(dto);
        }
        ...
        public async Task<IResultModel> Update(TenantAddDto dto)
        {
            ...
            return await _tenantService.Update(dto);
        }
        ...
        {
            return await _tenantService.Del(primaryKey);
        }
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<FileContentResult> ExportExcel(TenantQueryDto dto)
        {
            var buff = await _tenantService.ExportExcel(dto);
        ...
        {
            return await _tenantService.ImportExcel(formFile);
        }
