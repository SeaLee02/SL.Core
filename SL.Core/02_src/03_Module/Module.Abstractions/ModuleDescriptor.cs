namespace SL.Module.Abstractions
{
    ...
    public class ModuleDescriptor
    {
        ...
        /// 应用服务集合
        /// </summary>
        public Dictionary<Type, Type> ApplicationServices { get; set; } =new Dictionary<Type, Type>();

        /// <summary>
        /// 分层信息
        /// </summary>
        public ModuleLayerAssemblies LayerAssemblies { get; } =new ModuleLayerAssemblies();

        /// <summary>
        /// 枚举描述符集合
        /// </summary>
        public List<ModuleEnumDescriptor> EnumDescriptors { get; } = new List<ModuleEnumDescriptor>();
