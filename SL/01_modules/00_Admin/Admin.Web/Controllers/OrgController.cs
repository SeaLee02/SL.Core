...
using SL.Mkh.Admin.Core.Application.Org;
...
namespace SL.Mkh.Admin.Web.Controllers
{
    ...
    public class OrgController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<IResultModel> GetList([FromQuery] OrgQueryDto dto)
        {
            return await _orgService.GetList(dto);
        }
        ...
        {
            return await this._orgService.GetInfoById(primaryKey);
        }
        ...
        public async Task<IResultModel> Add(OrgAddDto dto)
        {
            ...
            return await _orgService.Add(dto);
        }
        ...
        public async Task<IResultModel> Update(OrgAddDto dto)
        {
            ...
            return await _orgService.Update(dto);
        }
        ...
        {
            return await _orgService.Del(primaryKey);
        }
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<FileContentResult> ExportExcel(OrgQueryDto dto)
        {
            var buff = await _orgService.ExportExcel(dto);
        ...
        {
            return await _orgService.ImportExcel(formFile);
        }
